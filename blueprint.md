...
This project is a web-based lottery number generator with a modern dark/light mode toggle and a partnership inquiry form powered by Formspree.
...
*   **Styling:** Custom styled to match the application's theme (Dark/Light).

### Web Components
*   **`lotto-ball`:** A custom element that represents a lottery ball with dynamic number and color.
